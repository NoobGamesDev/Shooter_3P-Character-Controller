...
void AItem::BeginPlay()
{
	...
	// Sets ActiveStars based on Item Rarity
	SetActiveStars();
...
void AItem::StartItemCurve(AShooterCharacter* Char, bool bForcePlaySound)
{
	...
	// Add 1 to the ItemCount for the Interp Location Struct
...
void AItem::ItemInterp(float DeltaTime)
{
	...
	{
		// Time that has passed since ItemInterpTimer started
		...
		// Delta Vector from Item to Camera Interp Location, X and Y are zeroed out
		...
		// Adding CurveValue to the Z component of the Initial Location (scaled by DeltaZ)
		...
		FRotator ItemRotation { 0.f, CameraRotation.Yaw + InterpInititialYawOffset, 0.f };
...
void AItem::OnConstruction(const FTransform& Transform)
{
	...
	// Path to the ItemRarity DataTable

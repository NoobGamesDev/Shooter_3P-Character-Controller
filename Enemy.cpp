	...
	RightWeaponSocket(TEXT("FX_Trail_R_01"))
{
	...
	CombatRangeSphere = CreateDefaultSubobject<USphereComponent>(TEXT("Combat Range"));
	CombatRangeSphere->SetupAttachment(GetRootComponent());

	// Construct the left and right weapon collision hit boxes
...
void AEnemy::BeginPlay()
{
	...
	// Bind Functions to overlap events for the Weapon Hit boxes
	LeftWeaponCollision->OnComponentBeginOverlap.AddDynamic(
	this,
	&AEnemy::AEnemy::OnLeftWeaponOverlap);
	RightWeaponCollision->OnComponentBeginOverlap.AddDynamic(
	this,
	&AEnemy::OnRightWeaponOverlap);
	// Set collision presets for the Weapon Hit boxes
	...
	// Ignore ShooterCharacter Camera for Mesh and Capsule
	GetMesh()->SetCollisionResponseToChannel(
